...
public class Projects {
    ...
    private BigDecimal psGetmoney;

    private Integer psGetpeople;

    private Integer psAuditor;
    ...
    public BigDecimal getPsMoney() {
        return psMoney;
    }

    public void setPsMoney(BigDecimal psMoney) {
    ...
    public BigDecimal getPsGetmoney() {
        return psGetmoney;
    }

    public void setPsGetmoney(BigDecimal psGetmoney) {
    ...
    public Integer getPsAuditor() {
        return psAuditor;
    }

    public void setPsAuditor(Integer psAuditor) {
